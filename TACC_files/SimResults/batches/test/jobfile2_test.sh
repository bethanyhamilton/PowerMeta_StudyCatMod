#!/bin/bash
#SBATCH -J powstudcatmod_2b_test #Job name
#SBATCH -o powstudcatmod_2b_test.o%j  # Name of outputfile
#SBATCH -e powstudcatmod_2b_test.e%j  # Name of stderr error file
...
python3 /work2/08147/bethanyh/stampede3/work_files/pmcmlauncher2_test.py
