...
FileName2 <- paste("TACC_files/SimResults/batches/test/command_lines",batch_file,"_test" ,sep="")
...
for (i in 1:dim(params2)[1]) {
  # Construct the command string
  command <- paste('apptainer run --bind /scratch/08147/bethanyh/pylauncher_out', batch_file,'_test', ':/home/r-environment/output /scratch/08147/bethanyh/powstudcatmod_v0_test.sif R -e "source(\'/home/r-environment/run_sim_study.R\')" --args PYL_ID ', params2$PYL_ID[i], ' "/home/r-environment/output" ', batch_file ,sep = "")
