...
FileName2 <- paste("TACC_files/ApproximationResults/command_lines_approx", sep="")
...
for (i in 1:dim(params)[1]) {
  ...
  command <- paste('apptainer run --bind /scratch/08147/bethanyh/pylauncher_out_approx:/home/r-environment/output /scratch/08147/bethanyh/powstudcatmod_approx_v0.sif R -e "source(\'/home/r-environment/run_approx_study.R\')" --args PYL_ID ', params$PYL_ID[i], ' "/home/r-environment/output" ' ,sep = "")
